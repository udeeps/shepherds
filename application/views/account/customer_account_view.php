...
<body>
  ...
  <div class="row">
    ...
    <div class="twelve columns">
      ...
      <p>A message to welcome the user to the system, possibly explaining the basic functionality of the application so that there's less need for support. Just a couple of lines to not burden the user with text. Just a bit more, just to see how the layout responds to the amount of content.</p>
    </div>
  </div>
  ...
  <div class="row content"> <!-- Start App Content -->
    ...
    <div class="twelve columns ">
      ...
      <a href="details.html"><ul class="listing"> <!-- Start single task listing -->
        <li class="panel">
